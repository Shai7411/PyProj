                            ...
                            if request.status == 200:
                                ...
                                for i in wordlist:
                                    ...
                                    if request.status == 200:
                                        ...
                                        print(f"[{counter}] | {url}/{i} | {colors.RED}Page Not Found.{colors.NORMAL}")
                                ...
                                while True:
                                    ...
                                    if output == "y".lower():
                                        output_path = input(f"{colors.BLUE}Enter a path where you like to save the file: {colors.NORMAL}")
                                        for i in xlist:
